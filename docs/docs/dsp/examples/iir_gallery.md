...
* [4th-order Butterworth filter, bandpass](#4th-order-butterworth-filter-bandpass)
...
|||using namespace kfr;
|||
|||TEST_CASE("dsp/examples/iir_gallery.md/24th-order Bessel lowpass")
|||{
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/12th-order Bessel lowpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/6th-order Bessel lowpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/24th-order Butterworth lowpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/12th-order Butterworth lowpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/12th-order Butterworth highpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/12th-order Butterworth bandpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/12th-order Butterworth bandstop")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/4th-order Butterworth bandpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/8th-order Chebyshev type I lowpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/8th-order Chebyshev type II lowpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/iir_gallery.md/10th-order elliptic lowpass")
|||{
const std::string options = "phaseresp=True, log_freq=True, freq_dB_lim=(-160, 10), padwidth=8192";
constexpr size_t maxorder = 32;
univector<fbase, 1024> output;
