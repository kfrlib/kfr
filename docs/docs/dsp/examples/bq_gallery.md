...
|||using namespace kfr;
|||
|||TEST_CASE("dsp/examples/bq_gallery.md/high shelf")
|||{
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/bq_gallery.md/lowpass")
|||{
const std::string options = "phaseresp=True";
univector<fbase, 128> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/bq_gallery.md/low shelf")
|||{
const std::string options = "phaseresp=True";
univector<fbase, 128> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/bq_gallery.md/notch cascade")
|||{
const std::string options = "phaseresp=True";
univector<fbase, 128> output;
...
## Biquad Peak filter (0.3, 0.5, +9dB)

Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/bq_gallery.md/peak boost")
|||{
const std::string options = "phaseresp=True";
univector<fbase, 128> output;
...
|||CHECK(output[0] != fbase(0));
||||||||||
plot_save("biquad_peak", output, options + ", title='Biquad Peak filter (0.3, 0.5, +9)'");
||||||||||
|||}
```
Result
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/bq_gallery.md/peak cut")
|||{
const std::string options = "phaseresp=True";
univector<fbase, 128> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/bq_gallery.md/bandpass")
|||{
const std::string options = "phaseresp=True";
univector<fbase, 128> output;
...
Code
```c++ linenums="1"
|||TEST_CASE("dsp/examples/bq_gallery.md/highpass")
|||{
const std::string options = "phaseresp=True";
univector<fbase, 128> output;
