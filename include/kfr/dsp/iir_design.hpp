...
KFR_FUNCTION zpk<T> butterworth(int N)
{
    ...
    case 3:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.5000000000000001, -0.8660254037844386),
    ...
    case 5:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.8090169943749475, -0.5877852522924731),
    ...
    case 7:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.9009688679024191, -0.4338837391175581),
    ...
    case 9:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.9396926207859084, -0.3420201433256687),
    ...
    case 11:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.9594929736144974, -0.28173255684142967),
    ...
    case 13:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.970941817426052, -0.23931566428755777),
    ...
    case 15:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.9781476007338057, -0.20791169081775931),
    ...
    case 17:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.9829730996839018, -0.18374951781657034),
    ...
    case 19:
        return { {},
                 { complex<T>(-1., -0.), complex<T>(-0.9863613034027223, -0.1645945902807339),
...
KFR_FUNCTION zpk<T> bessel(int N)
{
    ...
    case 3:
        return { {},
                 { complex<T>(-0.9416000265332067, -0.), complex<T>(-0.7456403858480766, -0.7113666249728353),
    ...
    case 5:
        return { {},
                 { complex<T>(-0.92644207738776, -0.), complex<T>(-0.8515536193688396, -0.44271746394433276),
    ...
    case 7:
        return { {},
                 { complex<T>(-0.919487155649029, -0.), complex<T>(-0.8800029341523379, -0.32166527623077407),
    ...
    case 15:
        return { {},
                 { complex<T>(-0.9097482363849062, -0.), complex<T>(-0.9006981694176978, -0.1537681197278439),
...
template <typename T>
KFR_FUNCTION univector<complex<T>> cplxreal(const univector<complex<T>>& x)
{
    // conjugate pairs must be adjacent
