    ...
    if (KFR_ENABLE_MULTIARCH AND LIB_MULTIARCH)
        ...
        foreach (ARCH IN LISTS KFR_ARCHS)
            ...
            foreach (ENABLED_ARCH IN LISTS KFR_ARCHS)
                ...
                target_compile_definitions(${LIB_NAME}_${ARCH} PRIVATE KFR_MULTI_ENABLED_${ENABLED_ARCH_UPPER}=1)   
            endforeach()
        ...
        target_compile_definitions(${LIB_NAME}_${BASE_ARCH} PRIVATE KFR_BASE_ARCH=1)
